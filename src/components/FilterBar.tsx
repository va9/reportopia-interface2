...
import { Plus, X, ChevronUp, ChevronDown, ChevronLeft, ChevronRight } from "lucide-react";
    ...
    <div className="fixed top-16 z-40 w-full">
      <div className="relative">
        <Button
          ...
          className="absolute -right-12 top-4 bg-white"
        >
          {isPanelVisible ? <ChevronLeft className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
        </Button>
        
        {isPanelVisible && (
          <div className="w-full px-6 py-4 bg-white/80 backdrop-blur-sm border-b">
